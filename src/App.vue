    ...
    <header id="header">
      <nav class="navbar">
        <div class="container">
          ...
          <div class="logo" id="logo2"> <RouterLink style="text-align: center;" to="/">
              <h3 style="color: #4d4d4f;">Geekshub</h3></RouterLink>
            </div>
          ...
          <div class="nav-links">
            <ul class="nav-group">
              <li class="nav-item" id="home"><a href=""><fa icon="home"/></a></li>

              <li style="position: relative;" class="nav-item"><a
                  href="{% url 'inbox:inboxpage' last_msg_friend_id %}?friends_area=true"><fa icon="inbox"/>
              ...
              <li class="nav-item"><a href=""><fa icon="plus"/></a></li>


              <li class="nav-item" id="search"><a href=""><fa icon="search"/></a>
              </li>
              ...
              <a href="{% url 'accounts:profile' request.user.id %}">
                <li class="nav-item">
                  <div class="action">
                    <div class="profile">
                      <img src="@/assets/default.jpg" alt="user Avatar">
                    </div>
                  </div>
                </li>
              </a>
